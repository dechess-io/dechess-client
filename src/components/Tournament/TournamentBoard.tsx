...
import {
  ...
  registerTournament,
  selectTournament,
} from '../../redux/tournament/tournament.reducer'
              ...
              <div className={`item ${i % 2 === 0 && round.length > 1 && 'show-brackets'}`}>
                <div className="box">
                  <div className={`part partOne  ${false ? 'looser' : ''} `}>
                    <div className="value">
                      {board.player1.player ? truncateSuiTx(board.player1.player, true) : 'TBD'}
                    </div>
                    <div className="score">{board.player1.player ? board.player1.score : 0}</div>
                  </div>
                  <div className={`part partOne  ${false ? 'looser' : ''} `}>
                    <div className="value">
                      {board.player2.player ? truncateSuiTx(board.player2.player, true) : 'TBD'}
                    </div>
  ...
  return (
    <>
      ...
      <div className="flex flex-col space-y-8 p-4 md:ml-64 mt-14 bg-white h-screen">
        <div className="border-none rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 min-h-screen flex flex-col items-center justify-center text-center">
